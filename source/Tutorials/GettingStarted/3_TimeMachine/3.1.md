...
The `GNUmakefile` tells the build system, [GNUstep Make](/Reference/Tools/Make/index.md), how to build the app. ProjectCenter makes on for you, but it's pretty easy to make one yourself.