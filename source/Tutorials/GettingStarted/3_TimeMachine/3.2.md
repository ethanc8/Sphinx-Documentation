...
- (id) initWithFrame: (NSRect) frame {
    ...
    self->labelDate = [[NSTextField alloc] initWithFrame: NSMakeRect(10, 45, 35, 20)];
    ...
    self->labelTime = [[NSTextField alloc] initWithFrame: NSMakeRect(10, 15, 35, 20)];
    ...
    self->localDate = [[NSTextField alloc] initWithFrame: NSMakeRect(55, 45, 130, 20)];
    self->localTime = [[NSTextField alloc] initWithFrame: NSMakeRect(55, 15, 130, 20)];
...
it. Since we don't need any of them, they are safe to be removed. In
`TimeView.h`, we declare four `NSTextField`s to add to my view, and one
